...
document.getElementById("irSaludMental").style.display = "none";
...
function procesarTrivia() {
  var correcta1 = document.getElementById("pregunta1_b").checked;
  var correcta2 = document.getElementById("pregunta2_b").checked;
  var correcta3 = document.getElementById("pregunta3_c").checked;
  var puntaje = 0;
  ...
  document.getElementById("irSaludMental").style.display = "block";
}